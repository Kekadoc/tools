package com.qeapp.tools.reflection;
...
public class QeReflection {
    ...
    /**
     * Найти все поля помеченные указанной антотацией
     */
    ...
    /** Возвращает массив всех анотаций включая суперклассы. */
    ...
    /** Возвращает все поля класса включая суперыклассы */
    ...
    /** Возвращает все интерфейсы класса включая суперыклассы */
