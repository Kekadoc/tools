...
import com.qeapp.tools.fraction.FractionObserver
import com.qeapp.tools.fraction.FractionUtils
import com.qeapp.tools.fraction.ObservableFraction
...
interface ValueRangeDouble : ValueDouble, Fraction {
    ...
    override fun getFraction(): Double {
        return FractionUtils.getFraction(getMin(), getMax(), getValue())
    }
...
interface ValueRangeFloat : ValueFloat, Fraction {
    ...
    override fun getFraction(): Double {
        return FractionUtils.getFraction(getMin().toDouble(), getMax().toDouble(), getValue().toDouble())
    }
...
interface ObservableValueRangeDouble : ValueRangeDouble {
    ...
    fun addValueObserver(observer: Observer)
    fun removeValueObserver(observer: Observer?)
...
open class ValueRangeDoubleImpl(private val value: Double,
    ...
    override fun addFractionObserver(observer: FractionObserver) {
        fractionObserver.addObserver(observer)
    }
    override fun removeFractionObserver(observer: FractionObserver?) {
        fractionObserver.removeObserver(observer)
    }

    override fun addValueObserver(observer: ObservableValueRangeDouble.Observer) {
        valueObserver.addObserver(observer)
    }
    override fun removeValueObserver(observer: ObservableValueRangeDouble.Observer?) {
        valueObserver.removeObserver(observer)
    }
...
open class ValueRangeFloatImpl(
    ...
    override fun addValueObserver(observer: ObservableValueRangeFloat.Observer) {
        valueObserver.addObserver(observer)
    }
    override fun removeValueObserver(observer: ObservableValueRangeFloat.Observer?) {
        valueObserver.removeObserver(observer)
    }
...
open class ValueRangeLongImpl(
    ...
    override fun addValueObserver(observer: ObservableValueRangeLong.Observer) {
        valueObserver.addObserver(observer)
    }
    override fun removeValueObserver(observer: ObservableValueRangeLong.Observer?) {
        valueObserver.removeObserver(observer)
    }
...
open class ValueRangeIntImpl(
    ...
    override fun addValueObserver(observer: ObservableValueRangeInt.Observer) {
        valueObserver.addObserver(observer)
    }
    override fun removeValueObserver(observer: ObservableValueRangeInt.Observer?) {
        valueObserver.removeObserver(observer)
    }
